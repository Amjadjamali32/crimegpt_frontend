...
const AdminSidebar = () => {
  ...
  return (
    <div className="h-full bg-custom-teal text-white font-inter shadow-lg">
      <div className="mt-[72px] p-4 text-left bg-blue-950 shadow-sm">
        <h2 className="text-md font-normal ms-4 font-inter">Admin Dashboard</h2>
      </div>
      <ul className="font-light text-sm">
        <li className="hover:bg-blue-900">
          <NavLink
            to="/admin-dashboard"
            className={({ isActive }) =>
              `flex items-center p-2.5 space-x-2 ${
        ...
        <li className="hover:bg-blue-900">
          ...
          >
            <EditNotificationsIcon className="fill-white mx-3.5 text-3xl"  />
        ...
        <li className="hover:bg-blue-900">
          ...
          >
            <Fingerprint className="fill-white mx-3.5" />
            <span>Evidence</span>
          </NavLink>
        </li>
        <li className="hover:bg-blue-900">
          ...
          >
            <FeedbackIcon className="fill-white mx-3.5" />
            <span>Feedback</span>
          </NavLink>
        </li>
        <li className="hover:bg-blue-900">
